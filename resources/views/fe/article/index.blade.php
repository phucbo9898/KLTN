                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="li-blog-single-item pb-25">
                            <div class="li-blog-banner">
                                <a href="{{route('get.article.detail', ['id' => $article->id])}}"><img class="img-full" src="{{asset('upload/a_image/'.$article->a_image)}}" alt=""></a>
                            </div>
                            <div class="li-blog-content">
                                <div class="li-blog-details">
                                    <h3 class="li-blog-heading pt-25"><a href="{{route('get.article.detail', ['id' => $article->id])}}" class="block-ellipsis">{{$article->a_name}}</a></h3>
