        ...
        <div class="row">
            ...
            <div class="col-lg-3 order-lg-2 order-2">
                ...
                @foreach($getListArticles as $getList)
                    <div style="margin-top: 20px"><a href="{{route('article.detail',$getList->id)}}">➤ <b>{{$getList->name}}</b></a></div>
                @endforeach
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="li-blog-single-item pb-30">
                            <div class="li-blog-banner">
                                <a href="#"><img class="img-full" src="{{asset($article->image)}}" alt=""></a>
                            </div>
                            <div class="li-blog-content">
                                <div class="li-blog-details">
                                    <h3 class="li-blog-heading pt-25"><a href="#">{{$article->name}}</a></h3>
                                    <div class="li-blog-meta">
                                        <a class="author" href="#"><i class="fa fa-user"></i>{{($article->user->name ?? '') ? $article->user->name : 'Admin'}}</a>
                                    ...
                                    <div class="article_content"><p>{!!$article->content!!}</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
