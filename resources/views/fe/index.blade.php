                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="{{route('product.index',[$product_new->pro_name_slug,$product_new->id])}}">
                                        @if(isset($product_new->pro_image))
                                            <img src="{{asset('upload/pro_image/'.$product_new->pro_image)}}" alt="Li's Product Image">
                                        @else
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <h4><a class="product_name" href="{{route('product.index',[$product_new->pro_name_slug,$product_new->id])}}">{{$product_new->pro_name}}</a></h4>
                                        ...
                                        <div class="price-box">
                                            @if($product_new->pro_sale>0)
                                                ...
                                                <span class="discount-percentage">-{{$product_new->pro_sale}}%</span><br/>
                                                <div class="old-price" style="padding-top: 6px">{{number_format($product_new->pro_price,0,",",".")}} VNĐ</div>
                                            @else
                                    ...
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                            <li class="add-cart active"><a class="button_add_cart" data-product-name="{{$product_new->pro_name}}" href="{{route('shopping.add.product',$product_new->id)}}">Mua sản phẩm</a></li>
                                            <li><a class="links-details button_add_favorite_product" data-product-name="{{$product_new->pro_name}}" href="{{route('get.add.favorite.product',$product_new->id)}}"><i class="fa fa-heart-o"></i></a></li>
                                            <li><a href="{{route('product.index',[$product_new->pro_name_slug,$product_new->id])}}" title="quick view" class="quick-view-btn"><i class="fa fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
