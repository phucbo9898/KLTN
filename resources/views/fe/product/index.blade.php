    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li><a href="{{route('category.index',[$product->category->slug,$product->category->id])}}">{{$product->category->name}}</a></li>
                ...
                <div class="product-details-view-content sp-normal-content pt-30">
                    <div class="product-info">
                        ...
                        <div class="price-box pt-20">
                            @if($product->sale>0)
                                <span class="new-price" style="color: black; text-decoration: line-through;">{{number_format($product->price,0,",",".")}} VNĐ</span>
                                <div class="new-price new-price-2" style="padding-top: 6px; color: black">Giảm giá {{$product->sale}}% chỉ còn: <span style="color: red">{{number_format(($product->price*(100-$product->sale))/100,0,",",".")}} VNĐ</span></div>
                             @else
                        ...
                        <div class="single-add-to-cart">
                            <div style="display: flex">
                                <div class="hm-wishlist mr-3" >
                                    <a  class="button_add_favorite_product" id="hm-wishlist_by_me" data-product-name="{{$product->name}}" href="{{route('favorite-product.get.add',$product->id)}}">
...
{{--                                @dd($product)--}}
                                <div class="cart-quantity">
                                    <a href="{{route('shopping.add.product',$product->id)}}" data-product-name="{{$product->name}}" class="button_add_cart">
                                ...
                                <div class="item_rating" style="display:flex; align-items: center;">
                                    ...
                                    <div style="width:30%">
                                       @foreach($eachstar as $key => $value)
                                           @if($key == $i)
                                                @if($product->total_star>0)
                                                    <a href="#">{{$value}} đánh giá ({{round(($value/$product->number_of_reviewers)*100,2)}}%)</a>
                                                @else
