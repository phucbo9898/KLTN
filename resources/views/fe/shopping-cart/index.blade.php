                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($product->options->image)
                                        <td class="li-product-thumbnail" style="width: 16%"><a href="#"><img style="width: 100%; height: 150px;" src="{{asset($product->options->image)}}" alt="Li's Product Image"></a></td>
                                    @else
                                    ...
                                    <td class="quantity">
                                        <form action="{{route('shopping.edit.product')}}" method="POST">
                                            ...
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" value="{{$product->qty}}" name="number_product_edit" type="number" min="1">
