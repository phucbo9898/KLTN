            ...
            <form action="" method="POST" class="col-md-10 mx-auto" enctype="multipart/form-data">
                ...
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{ old('name') ?? ($slide->name ?? '') }}" placeholder="Nhập tên slide...">
                    </div>
                    <div class="form-group">
                        <label>Ảnh mô tả: </label>
                        <img  id="img_output" class="form-control" style="width:480px;height:360px; margin-bottom:10px" src="{{asset($slide->image ?? '')}}"/>
