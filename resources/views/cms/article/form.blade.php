...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="name"
        value="{{ old('name', isset($article->name) ? $article->name : '') }}" placeholder="Nhập tên bài viết...">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    @if (isset($article->image))
        <img id="img_output" class="form-control" style="width:240px;height:180px; margin-bottom:10px"
...
<div class="form-group">
    ...
    <textarea class="form-control" cols="30" rows="5" name="content" id="ckeditor"
        placeholder="Nhập nội dung bài viết">{{ old('content', isset($article) ? $article->content : '') }}</textarea>
</div>
