...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="name"
        value="{{ old('name', isset($attribute->name) ? $attribute->name : '') }}" placeholder="Nhập tên thuộc tính...">
</div>
<div class="form-group ">
    <label>Kiểu: </label>
...
<div class="form-group" id="textAreaForAttribute" style="display: none">
    ...
    <textarea class="form-control" rows="5" name="value" id="contentTextAreaForAttribute">{{ isset($attribute) ? $attribute->value : '' }}</textarea>
</div>
