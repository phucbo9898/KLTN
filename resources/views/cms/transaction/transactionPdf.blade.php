<html>
    ...
    <body style="font-family:DejaVuSans">
        <img src="{{asset('images/1.png')}}" alt="" style="width: 90px;">
        <center><span style="font-weight: bolder;font-size: 1.75rem;" >CHI TIẾT GIAO DỊCH SỐ {{$transaction->id}}</span></center><br>
            ...
            <tbody>
                @foreach($transaction->Order as $order)
                    <tr>
                        ...
                        <td style="text-align: center;">{{$order->or_qty}}</td>
